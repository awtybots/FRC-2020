...
public final class Constants
{
    ...
    {
        public final static boolean IS_TUNING = false; // enable PID/FeedForward tuning on SmartDashboard

        // Mappings/Preferences
        public final static MotorControlMode MOTOR_CONTROL_MODE = MotorControlMode.PID;       // target velocity --> motor output
        public final static DriveMode DRIVE_MODE                = DriveMode.RAMPED_PERCENT;   // acceleration curve of motors
        public final static DriveControls DRIVE_CONTROLS        = DriveControls.ARCADE_DRIVE; // stick input --> target veocity
    ...
    public final static class Shooter
    {
        ...
        public final static double TARGET_THRESHOLD_DEG = 1; // degrees
        public final static double TARGET_SLOW_THRESHOLD_DEG = 15; // degrees
    }

    public final static class Limelight
    {
        public final static double HORIZONTAL_SKEW = 1.75; // degrees
        public final static double MOUNTING_ANGLE = 41; // degrees
    ...
    public final static class ControlPanelSpinner
    {
        ...
        public final static double VERIFY_COLOR_SEC = 0.03; // wait time to verify color (0.125s is 60 RPM)
        public final static double MIN_COLOR_CONFIDENCE = 0.95; // Must be this sure before declaring color
    }
}
